                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                ...
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                  <b><h3> <span> تسجيل الدخول <b><small>الادارة</small></b></span></h3></b>
                                </h6>
                            </div>
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="{{route('login')}}" novalidate method="post">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" name="email" class="form-control input-lg" id="user-name" placeholder="اسم المستخدم او البريد الالكتروني"
                                                   tabindex="1" required data-validation-required-message="الرجاء كتابة اسم المسخدم او البريد الالكتروني.">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" name="password" class="form-control input-lg" id="password" placeholder="أدخل كلمة المرور"
                                                   tabindex="2" required data-validation-required-message="الرجاء كتابة كلمة المرور.">
                                            <div class="form-control-position">
                                                <i class="la la-key"></i>
                                            </div>
                                            <div class="help-block font-small-3"></div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-12 text-center text-md-right"><a href="recover-password.html" class="card-link">نسيت كلمة المرور؟</a></div>
                                        </div>
