        ...
        <div class="table-responsive mb-4">
          <table class="table text-nowrap">
            <thead class="bg-light">
              <tr>
                <th class="border-0 p-3" scope="col"> <strong class="text-sm text-uppercase">رقم الاشعار</strong></th>
            ...
            <tbody class="border-0">
                ...
                @foreach ($noti_stu as $data)

                        <tr>
                            <th class="ps-0 py-3 border-light" scope="row">
                            <p class="mb-0 small"><a href="{{route('stu.show.noti',$data->id)}}">{{$data->id}}</a></p>
                            </th>
                            ...
                            <td class="p-3 align-middle border-light">
                            <p class="mb-0 small">{{ $data->data['status']  .' في '. $data->updated_at }}</p>
                            </td>
