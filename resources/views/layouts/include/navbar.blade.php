            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{route('dashboard')}}">
                        <img class="brand-logo" alt="modern admin logo" src="{{asset('5.png')}}">
                        <h3 class="brand-text">
                            @if(app()->getLocale() == 'en')
                             Students Delevery
                            @else
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">Hello,
                  ...
                  <img  src="{{asset('dash-rtl/app-assets/images/ico/apple-icon-60.png')}}" /><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
                                                                       aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-om"></i><span class="selected-language"></span></a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                            <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{$noti_unread->count()}}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span class="notification-tag badge badge-default badge-danger float-right m-0">{{$noti_unread->count()}}</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
                                @forelse ($noti_unread as $noti_data)
                                <a href="{{route('read.admin.noti', [$noti_data->data['order_id'] , $noti_data->id]) }}">
                                    <div class="media">
                                        <div class="media-left align-self-center"><i class="ft-file icon-bg-circle bg-teal"></i></div>
                                        <div class="media-body">
                                            <h6 class="media-heading">لقد قام الطالب : <b>{{$noti_data->data['name']}} بطلب وجبة</b></h6>
                                            <small>
                                                <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">{{$noti_data->created_at->diffForHumans()}}</time>
                                            </small>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left align-self-center"><i class="ft-file icon-bg-circle bg-teal"></i></div>
                                        <p>لاتوجد اي اشعارات في الوقت الحالي</p>
                                    </div>
                                </a>
                                @endforelse

                            </li>
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center" href="javascript:void(0)">كل الاشعارات</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
