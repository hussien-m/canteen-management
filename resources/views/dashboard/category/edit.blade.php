        ...
        <div class='col-md-12'>
            <div class="card bg-light mt-3">
                ...
                <div class="card-body">
                    ...
                    <form  action="{{route('category.update', $m_cat->id)}}" method="post">
                        @csrf
                        ...
                        <fieldset class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="basicInput" value="{{$m_cat->name}}">
                        </fieldset>


                        <fieldset class="form-group">

                            <input type="submit" class="btn btn-primary"  value="تعديل التصنيف">
