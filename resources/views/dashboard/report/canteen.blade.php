            ...
            <div class="card-body table-responsive">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <form action="{{route('report.canteen')}}" method="get">
                            <div class="form-row align-items-center">
                              <div class="col-sm-6 my-1">
                                <input type="text" name="name" class="form-control"  placeholder="اسم المقصف" value="">
                              </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('admin.order.delete',$order->id)}}">
                                   @csrf
                                   @method('delete')
                                   <button type="submit" name="submit" class="del_order">حذف</button>
                                </form>
                            </td>
