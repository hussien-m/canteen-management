    ...
    <div class="col-md-12">
        <div class="card" style="">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    <form class="form" action="{{route('admin.changePostImage',$user_id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <h4 class="form-section"><i class="ft-user"></i> تغيير الصورة الشخصية </h4>
                            <div class="row">
                                <div class="form-group col-md-6 mb-2">
                                    <label for="projectinput1"> الصورة الجديدة</label>
