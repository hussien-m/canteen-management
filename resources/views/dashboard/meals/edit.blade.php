                ...
                <div class="card-body">
                    ...
                    <form  action="{{route('admin.meal.update' ,$meal->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="basicInput" value="{{$meal->name ?? old('name')}}">
                        </fieldset>

                        <fieldset class="form-group">
                            <label for="price" id="">السعر</label>
                            <input type="number" name="price" class="form-control" id="price"  min="0" step="0.001" max="100" value="{{$meal->price ?? old('price') }}" >
                        </fieldset>
                        ...
                        <fieldset class="form-group">
                            ...
                            <select name="category" id="maincategory" class="form-control">
                                ...
                                @foreach ($main_category= App\Models\MainCategory::get() as $cat )
